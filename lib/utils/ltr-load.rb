...
module LTR
  ...
  class ESClient
    ...
    def append(doc)
      track_id = (doc['artist']+"#"+doc['title']).hash
      buffer.push({ index: { _index: "docs", _type: 'docs', _id: track_id, data: doc } })
...
if __FILE__ == $0
  ...
  base = "/Volumes/Seagate Backup Plus Drive/Datasets/lastfm/train"
  alphabet.each_slice(1).each do |slice|
